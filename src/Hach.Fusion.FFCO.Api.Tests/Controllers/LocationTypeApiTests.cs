...
{
    [TestFixture]
    public class LocationTypeApiTests
    {

        private LocationTypesController _controller;
        ...
        public LocationTypeApiTests()
        {
            ...
            _mockDtoOptions = new Mock<ODataQueryOptions<LocationTypeQueryDto>>(
                new ODataQueryContext(builder.GetEdmModel(), typeof(LocationTypeQueryDto), new ODataPath()),
                request);
