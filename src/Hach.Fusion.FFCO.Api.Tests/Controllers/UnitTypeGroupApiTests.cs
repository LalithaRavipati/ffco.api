...
{
    [TestFixture]
    public class UnitTypeGroupApiTests
    {

        private UnitTypeGroupsController _controller;
        private readonly Mock<ODataQueryOptions<UnitTypeGroupQueryDto>> _mockDtoOptions;
        private DataContext _context;
        private UnitTypeGroupFacade _facade;
        private Guid _userId = Data.Users.tnt01user.Id;

        public UnitTypeGroupApiTests()
        {
            ...
            _mockDtoOptions = new Mock<ODataQueryOptions<UnitTypeGroupQueryDto>>(
                new ODataQueryContext(builder.GetEdmModel(), typeof(UnitTypeGroupQueryDto), new ODataPath()),
                request);
        ...
        private static ODataModelBuilder BuildODataModel()
        {
            ...
            builder.EntityType<UnitTypeGroupQueryDto>().HasKey(x => x.Id);
        ...
        public void Setup()
        {
            ...
            _facade = new UnitTypeGroupFacade(_context, new UnitTypeGroupValidator());

            ODataHelper oDataHelper = new ODataHelper();

            _controller = new UnitTypeGroupsController(oDataHelper, _facade);
